...
ActiveRecord::Schema.define(version: 20161005141704) do
  ...
  create_table "content_entries", force: :cascade do |t|
    ...
    t.string   "attached_file_id",           limit: 255
    t.string   "attached_file_filename",     limit: 255
  ...
  add_index "overlays", ["overlay_type_id"], name: "index_overlays_on_overlay_type_id", using: :btree
