  ...
  render() {
    ...
    return (
      <div>
        ...
        <AddPinToCollection all_collections={this.props.data.all_collections} team_collections={this.props.data.team_collections} user_collections={this.props.data.user_collections} />
