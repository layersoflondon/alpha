  ...
  render () {
    return(
      <div className="form-group form-group-upload">
        ...
        <input type="file" name={this.props.field_name} onChange={this.updateAttachmentAttribute.bind(this)} data-parsley-required='true' data-parsley-error-message={this.props.validation_failed_message} accept={this.props.file_types} />
      </div>
    );
  }
}
