  ...
  render () {
    return(
      <div className="form-grouping form-grouping--pin-type">
        ...
        <PinAttachmentFields title="Select a text file" field_name="text" file_types=".txt" required={this.state.content.length==0} validation_failed_message="Please attach a text file" />
      </div>
    )
  }
}
